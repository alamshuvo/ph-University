...
import SemesterRegestation from "../pages/admin/courseManagement/SemesterRegestation";
    ...
    children: [
      {
        ...
        element: <SemesterRegestation></SemesterRegestation>
      },
      {
        name:"All Registered Semester",
        path:"all-register-semester",
